...
```{definition}
Una variable aleatoria $Y$ tiene distribución uniforme discreta sobre el conjunto $\{1,2,\cdots,N\}$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución uniforme discreta sobre el conjunto $\{1,2,\cdots,N\}$, entonces:
...
```{definition}
Una variable aleatoria $Y$ tiene distribución hipergeométrica con parámetros $n$, $R$ y $N$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución hipergeométrica con parámetros $n$, $R$ y $N$, entonces:
...
```{definition}
Una variable aleatoria $Y$ tiene distribución Bernoulli con parámetro $p\in (0,1)$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución Bernoulli con parámetro $p$, entonces:
...
```{definition}
Una variable aleatoria $Y$ tiene distribución binomial con los parámetros $n\in \mathbb{N}$ y $p\in (0,1)$ si su función de densidad está dada por:
...
```{proposition}
Sea $Y_1$, $\cdots$, $Y_n$ variables aleatorias independientes e idénticamente distribuidas con distribución Bernoulli con parámetro $p$,
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución binomial con parámetros $n$ y $p$, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución Binomial negativa con parámetros $(\theta, r)$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución binomial-negativa con parámetros $(\theta, r)$, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución de Poisson con parámetros $\lambda>0$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución Poisson con parámetro $\lambda$, entonces
...
```{proposition}
Sea $Y_1$, $\cdots$, $Y_n$ variables aleatorias independientes con distribución $P(\lambda_i)$ para $i=1,\cdots,n$, entonces la variable $\sum_{i=1}^nX_i$ tiene distribución $P(\sum_{i=1}^n\lambda_i)$.
```
...
```{definition}
Una variable aleatoria $Y$ tiene distribución uniforme continua sobre el intervalo $[a,b]$ con $a<b$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución uniforme continua sobre $[a,b]$, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución uniforme continua sobre los reales positivos si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución Weibull, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución valor-extremo si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución valor-extremo, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución Gamma con parámetro de forma $\alpha>0$ y parámetro de escala $\theta>0$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución Gamma con parámetro de forma $\alpha$ y parámetro de escala $\theta$, entonces
...
```{proposition}
Sea $Y_1$, $\cdots$, $Y_n$ variables aleatorias independientes con distribución Gamma con parámetro de forma $\alpha_i$ y parámetro de escala $\beta$ para $i=1,\cdots,n$, entonces la variable $\sum_{i=1}^nX_i$ tiene distribución Gamma con parámetro de forma $\sum_{i=1}^n\alpha_i$ y parámetro de escala $\theta$.
```

### Distribución Gamma-inversa

```{definition}
Una variable aleatoria $Y$ tiene distribución Gamma-inversa con parámetro de forma $\alpha>0$ y parámetro de escala $\beta>0$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución Gamma-inversa con parámetro de forma $\alpha$ y parámetro de escala $\beta$, entonces
...
```{proposition, gammainver}
Si $X$ es una variable aleatoria con distribución $Gamma(\alpha,\beta)$, entonces $1/X$ tiene distribución $Gamma-inversa(\alpha,1/\beta)$.
```

### Distribución exponencial

```{definition}
Una variable aleatoria $Y$ tiene distribución exponencial con parámetro de escala $\theta>0$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución exponencial con parámetro $\theta$, entonces
...
```{proposition}
Sea $Y_1$, $\cdots$, $Y_n$ variables aleatorias independientes e idénticamente distribuidas con distribución exponencial con parámetro de escala $\theta$, entonces la variable $\sum_{i=1}^nX_i$ tiene distribución Gamma con parámetro de forma $n$ y parámetro de escala $\theta$.
```

### Distribución Beta

```{definition}
Una variable aleatoria $Y$ tiene distribución Beta con parámetro de forma $\alpha>0$ y parámetro de escala $\beta>0$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución Gamma con parámetro de forma $k$ y parámetro de escala $\theta$, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución normal con parámetros $\mu$ y $\sigma^2$ si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución normal con parámetros $\mu$ y $\sigma^2$, entonces
...
```{proposition}
Si $Y\sim N(\mu,\sigma^2)$, y $\alpha$, $\beta$ son constantes, entonces la variable $\alpha Y+\beta$ tiene distribución $N(\alpha\mu+\beta,\alpha^2\sigma^2)$.
```
<br>
...
```{proposition}
Sea $Y_1$, $\cdots$, $Y_n$ variables aleatorias independientes, donde $Y_i\sim N(\mu_i,\sigma^2_i)$ con $i=1,\cdots,n$, entonces la variable $\sum_{i=1}^nY_i$ tiene distribución $N(\sum_{i=1}^n\mu_i,\sum_{i=1}^n\sigma_i^2)$.
```

### Distribución log-normal

```{definition}
Una variable aleatoria $Y$ tiene distribución log-normal si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución log-normal, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución Ji-cuadrado con $n$ grados de libertad, con $n$ entero positivo, si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución Ji-cuadro con $n$ grados de libertad, entonces
...
```{proposition}
Sea $Z_1$, $\cdots$, $Z_m$ variables aleatorias independientes con distribución $\chi^2_{n_i}$ para $i=1,\cdots,m$, entonces la variable $\sum_{i=1}^mZ_i$ tiene distribución Ji-cuadrado con $\sum_{i=1}^mn_i$ grados de libertad.
```
...
```{definition}
Una variable aleatoria $Y$ tiene distribución t-student con $n$ grados de libertad si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución t-student con $n$ grados de libertad, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución t-student con $n$ grados de libertad, parámetro de centralidad $\theta$ y parámetro de escala $\sigma^2$, si su función de densidad está dada por:
...
```{proposition}
Si $Y$ es una variable aleatoria con distribución t-student generalizada, entonces
...
```{definition}
Una variable aleatoria $Y$ tiene distribución F con $m$ grados de libertad en el numerador y $n$ grados de libertado en el denominador si su función de densidad está dada por:
...
```{definition}
Sea $Y$ y $Y$ variables aleatorias independientes con distribuciones Ji-cuadrado con $m$ y $n$ grados de libertad, respectivamente, entonces la variable $\frac{Y/m}{Y/n}$ tiene distribución F con $m$ grados de libertad en el numerador y $n$ grados de libertado en el denominador.
``` 

```{proposition}
Si $Y$ es una variable aleatoria con distribución F con $m$ grados de libertad en el numerador y $n$ grados de libertado en el denominador, entonces
...
```{definition}
Un vector aleatorio $\mathbf{Y}=(Y_1,\ldots,Y_p')$ tiene distribución multinomial si su función de densidad está dada por:
...
```{proposition}
Si $\mathbf{Y}$ es una vector aleatorio con distribución multinomial, entonces
...
```{definition}
Un vector aleatorio $\mathbf{Y}=(Y_1,\ldots,Y_p')$ tiene distribución Dirichelt si su función de densidad está dada por:
...
```{proposition}
Si $\mathbf{Y}$ es una vector aleatorio con distribución Dirichlet, entonces
...
```{definition}
Un vector aleatorio $\mathbf{Y}=(Y_1,\ldots,Y_p')$ tiene distribución normal multivariante de orden $p$, denotada como $\mathbf{Y}\sim N_p(\btheta,\bSigma)$, si su función de densidad está dada por:
...
```{proposition, normalmulti}
Si $\mathbf{Y}=(Y_1,\ldots,Y_p')$ es una vector aleatorio con distribución normal multivariante, entonces
...
```{proposition}
Si $\mathbf{Y}$ es una vector aleatorio con distribución Normal Multivariante, entonces
...
```{proposition}
Dado $\mathbf{Y}$ un vector aleatorio particionado como $\mathbf{Y}=(\mathbf{Y}_1',\mathbf{Y}_2')$ con esperanza $\btheta=(\btheta_1',\btheta_2')$ y matrix de varianzas y covarianzas
...
```{proposition}
Si $\mathbf{Y}_1,\ldots,\mathbf{Y}_n$ es una muestra aleatoria de vectores con distribución Normal Multivariante, entonces la verosimilitud de la muestra se puede escribir como
...
```{definition}
Sea $\bSigma$ una matriz aleatoria simétrica y definida positiva de tamaño $p\times p$. Se dice que $\bSigma$ tiene distribución Wishart con $v$ grados de libertad, denotada como $\mathbf{Y}\sim Wishart_v(\bLambda)$, si su función de densidad está dada por:
...
```{proposition}
Si $\bSigma$ es una matriz aleatoria con distribución Wishart con $v$ grados de libertad, entonces $E(\bSigma)=v\bLambda$
```
...
```{proposition}
Si $\bSigma$ es una matriz aleatoria con distribución inversa-Wishart con $v$ grados de libertad, entonces $E(\bSigma)=\dfrac{1}{v-p-1}\bLambda$
```

```{proposition}
Si $\bSigma^{-1}$ es una matriz aleatoria con distribución inversa-Wishart, entonces con $\bSigma$ tiene distribución Wishart.
```
