...
```{r, BinomEj1, fig.cap="Función de densidad previa y función de densidad posterior para el ejemplo de bateo."}
p <- ggplot(data = data.frame(x = 0), 
            mapping = aes(x = x)) + 
...
```{r, PredBinom, fig.cap="Función de densidad predictiva posterior para el jugador Max Alvis."}
