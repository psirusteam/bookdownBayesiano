...
```{example, BeisbolJerarquico}
En el ejemplo \@ref(exm:Beisbol) se estudiaron datos que correspondían al porcentaje de bateo de 18 jugadores profesionales de beisbol. A continuación se representa los cálculos necesarios para obtener una inferencia bayesiana empírica apropiada. 
```
