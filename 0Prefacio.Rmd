...
```{r results = 'asis', out.width="600px", fig.cap="Tomado de *BayesAna*", echo=FALSE}
download.file(url = "https://i0.wp.com/anabelforte.com/wp-content/uploads/2020/07/4.gif",
          destfile = "Pics/fig1.png",
          mode = 'wb')
knitr::include_graphics(path = "Pics/fig1.png")
```
