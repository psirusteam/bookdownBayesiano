...
<div class="figure">
<img src="3Uniparametricos_files/figure-html/posBernoulliStan-1.png" alt="Distribución posterior." width="672" />
...
<div class="figure">
<img src="3Uniparametricos_files/figure-html/posBinomialStan-1.png" alt="Distribución posterior." width="672" />
...
## 
##        mean se_mean     sd   2.5% 97.5% n_eff   Rhat
## theta 0.005   1e-04 0.0021 0.0018  0.01  1594 1.0023
## 
## Samples were drawn using NUTS(diag_e) at Sat Jun  5 15:12:47 2021.
## For each parameter, n_eff is a crude measure of effective sample size,
## and Rhat is the potential scale reduction factor on split chains (at 
## convergence, Rhat=1).
```
...
## 
##         mean se_mean    sd   2.5% 97.5% n_eff   Rhat
## theta 0.0052       0 4e-04 0.0044 0.006  1534 0.9998
## 
## Samples were drawn using NUTS(diag_e) at Sat Jun  5 15:13:20 2021.
## For each parameter, n_eff is a crude measure of effective sample size,
## and Rhat is the potential scale reduction factor on split chains (at 
## convergence, Rhat=1).
```
...
<div class="figure">
<img src="3Uniparametricos_files/figure-html/posBNStan-1.png" alt="Distribución posterior." width="672" />
...
```
<div class="figure">
<img src="3Uniparametricos_files/figure-html/jefber-1.png" alt="Distribución predictiva posterior para el número de entrevistas necesarias para encontrar 5 pacientes." width="672" />
...
<div class="figure">
<img src="3Uniparametricos_files/figure-html/EjemPoisson1-1.png" alt="Histograma para los datos de accidentes de tránsito." width="672" />
...
<div class="figure">
<img src="3Uniparametricos_files/figure-html/EjemPoisson2-1.png" alt="Distribución previa y distribución posterior para el ejemplo del tránsito con dos distribuciones previas diferentes (el lado izquierdo representa el caso cuando se usa la previa no informativa, el lado derecho la previa informativa)." width="672" />
...
```
<div class="figure">
<img src="3Uniparametricos_files/figure-html/PredPostPoisson-1.png" alt="Distribución predictiva posterior para $n^*=1$ para el ejemplo del tránsito." width="672" />
...
## 
##          mean se_mean     sd    2.5%   97.5% n_eff   Rhat
## theta 12.2585  0.0029 0.1146 12.0344 12.4862  1596 1.0004
## 
## Samples were drawn using NUTS(diag_e) at Sat Jun  5 19:22:14 2021.
## For each parameter, n_eff is a crude measure of effective sample size,
## and Rhat is the potential scale reduction factor on split chains (at 
## convergence, Rhat=1).
```
...
<div class="figure">
<img src="3Uniparametricos_files/figure-html/posPoissonStan-1.png" alt="Distribución posterior." width="672" />
