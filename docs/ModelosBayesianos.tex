...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Exponencial }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}}
\StringTok{data \{}
\StringTok{  int\textless{}lower=0\textgreater{} n;}
...
\StringTok{\}}
\StringTok{transformed parameters \{}
\StringTok{  real\textless{}lower=0\textgreater{} invtheta = 1/theta;}
\StringTok{\}}
\StringTok{model \{}
\StringTok{  y \textasciitilde{} exponential(theta);}
\StringTok{  theta \textasciitilde{} gamma(0.1, 0.1);}
\StringTok{\}}
\StringTok{\textquotesingle{}}
\NormalTok{sample\_data }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\AttributeTok{y =}\NormalTok{ sobrevida}\SpecialCharTok{$}\NormalTok{tiempo, }
                    \AttributeTok{n =} \FunctionTok{nrow}\NormalTok{(sobrevida))}
\NormalTok{Expofit }\OtherTok{\textless{}{-}} \FunctionTok{stan}\NormalTok{(}\AttributeTok{model\_code =}\NormalTok{ Exponencial,}
                \AttributeTok{data =}\NormalTok{ sample\_data, }\AttributeTok{verbose =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(pscl)}
\FunctionTok{sapply}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\FloatTok{0.975}\NormalTok{), }
       \ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{qigamma}\NormalTok{(x, }\FloatTok{0.001}\NormalTok{, }\FloatTok{0.001}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pigamma}\NormalTok{(}\DecValTok{10}\NormalTok{, }\FloatTok{0.001}\NormalTok{, }\FloatTok{0.001}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NormalVar }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}}
\StringTok{data \{}
\StringTok{  int\textless{}lower=0\textgreater{} n;}
\StringTok{  real mu;}
\StringTok{  real y[n];}
...
\StringTok{  real y\_test[n];}
\StringTok{  for(i in 1:n) \{}
\StringTok{    y\_test[i] = normal\_rng(mu, sigma);}
\StringTok{  \}}
\StringTok{\}}
\StringTok{\textquotesingle{}}

\NormalTok{sample\_data }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Escuelas}\SpecialCharTok{$}\NormalTok{efecto, }
                    \AttributeTok{n =} \FunctionTok{nrow}\NormalTok{(Escuelas),}
                    \AttributeTok{mu =} \FunctionTok{mean}\NormalTok{(Escuelas}\SpecialCharTok{$}\NormalTok{efecto))}
\NormalTok{NormalVfit }\OtherTok{\textless{}{-}} \FunctionTok{stan}\NormalTok{(}\AttributeTok{model\_code =}\NormalTok{ NormalVar,}
                   \AttributeTok{data =}\NormalTok{ sample\_data, }\AttributeTok{verbose =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NormalVar2 }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}}
\StringTok{data \{}
\StringTok{  int\textless{}lower = 0\textgreater{} n;}
\StringTok{  real mu;}
\StringTok{  real y[n];}
...
\StringTok{  real sigma;}
\StringTok{  real sigma2;}
\StringTok{  sigma = exp(nu);}
\StringTok{  sigma2 = pow(sigma, 2);}
\StringTok{\}}
\StringTok{model \{}
\StringTok{  y \textasciitilde{} normal(mu, sigma);}
\StringTok{  nu \textasciitilde{} uniform(0.5, 20);}
\StringTok{\}}
\StringTok{generated quantities \{}
\StringTok{  real y\_test[n];}
\StringTok{  for(i in 1:n) \{}
...
\NormalTok{sample\_data }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Escuelas}\SpecialCharTok{$}\NormalTok{efecto, }
                    \AttributeTok{n =} \FunctionTok{nrow}\NormalTok{(Escuelas),}
                    \AttributeTok{mu =} \FunctionTok{mean}\NormalTok{(Escuelas}\SpecialCharTok{$}\NormalTok{efecto))}
\NormalTok{NormalVfit2 }\OtherTok{\textless{}{-}} \FunctionTok{stan}\NormalTok{(}\AttributeTok{model\_code =}\NormalTok{ NormalVar2,}
                   \AttributeTok{data =}\NormalTok{ sample\_data, }\AttributeTok{verbose =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}Acudiendo a la distribución posterior conjunta, e incorporando los términos que no dependen de \(\theta\) en la constante de proporcionalidad, se tiene que
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}En primer lugar, recordamos que la función de verosimilitud de la muestra está dada por
\begin{align}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}Acudiendo a la distribución posterior conjunta dada en \eqref{eq:desarro1}, tenemos que
\begin{align*}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}De la distribución posterior conjunta \eqref{eq:desarro1}, e integrando con respecto a \(\theta\), se tiene que
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}Partiendo de la distribución posterior conjunta e integrando con respecto a \(\sigma^2\), se tiene que
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}En primer lugar nótese que la distribución posterior conjunta de los parámetros de interés es
\begin{align}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}Utilizando el mismo argumento del anterior resultado, se tiene que
\begin{align*}
...
\addcontentsline{toc}{subsubsection}{Enfoque alterno para estimar \(\theta\) y \(\sigma^2\)}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}En primer lugar, nótese la siguiente identidad
\begin{equation}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}La prueba es inmediata notando que
\begin{align*}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}La prueba es inmediata al multiplicar las densidades y asignar los términos que no dependen de los parámetros de interés a la constante de proporcionalidad.
\end{proof}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}Utilizando propiedades de la distribución condicional, tenemos que
\begin{align*}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}Algunas simples operaciones algebráicas muestran que:
\begin{align*}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}En primer lugar recordamos la expresión
\begin{equation*}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(y[, }\DecValTok{1}\NormalTok{])}\SpecialCharTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(y[,}\DecValTok{2}\NormalTok{])}\SpecialCharTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{proof}
\iffalse{} {Prueba. } \fi{}De la definición de función de distribución predictiva posterior se tiene que
\begin{align*}
