...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-27}{}{\label{prp:unnamed-chunk-27} }Si \(X\) es una variable aleatoria con distribución \(Gamma(\alpha,\beta)\), entonces \(1/X\) tiene distribución \(Gamma-inversa(\alpha,1/\beta)\).
\end{proposition}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-28}{}{\label{def:unnamed-chunk-28} }Una variable aleatoria \(Y\) tiene distribución exponencial con parámetro de escala \(\theta>0\) si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-29}{}{\label{prp:unnamed-chunk-29} }Si \(Y\) es una variable aleatoria con distribución exponencial con parámetro \(\theta\), entonces
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-31}{}{\label{def:unnamed-chunk-31} }Una variable aleatoria \(Y\) tiene distribución Beta con parámetro de forma \(\alpha>0\) y parámetro de escala \(\beta>0\) si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-32}{}{\label{prp:unnamed-chunk-32} }Si \(Y\) es una variable aleatoria con distribución Gamma con parámetro de forma \(k\) y parámetro de escala \(\theta\), entonces
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-33}{}{\label{def:unnamed-chunk-33} }Una variable aleatoria \(Y\) tiene distribución normal con parámetros \(\mu\) y \(\sigma^2\) si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-34}{}{\label{prp:unnamed-chunk-34} }Si \(Y\) es una variable aleatoria con distribución normal con parámetros \(\mu\) y \(\sigma^2\), entonces
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-35}{}{\label{prp:unnamed-chunk-35} }Si \(Y\sim N(\mu,\sigma^2)\), y \(\alpha\), \(\beta\) son constantes, entonces la variable \(\alpha Y+\beta\) tiene distribución \(N(\alpha\mu+\beta,\alpha^2\sigma^2)\).
\end{proposition}
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-37}{}{\label{prp:unnamed-chunk-37} }Sea \(Y_1\), \(\cdots\), \(Y_n\) variables aleatorias independientes, donde \(Y_i\sim N(\mu_i,\sigma^2_i)\) con \(i=1,\cdots,n\), entonces la variable \(\sum_{i=1}^nY_i\) tiene distribución \(N(\sum_{i=1}^n\mu_i,\sum_{i=1}^n\sigma_i^2)\).
\end{proposition}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-38}{}{\label{def:unnamed-chunk-38} }Una variable aleatoria \(Y\) tiene distribución log-normal si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-39}{}{\label{prp:unnamed-chunk-39} }Si \(Y\) es una variable aleatoria con distribución log-normal, entonces
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-40}{}{\label{def:unnamed-chunk-40} }Una variable aleatoria \(Y\) tiene distribución Ji-cuadrado con \(n\) grados de libertad, con \(n\) entero positivo, si su función de densidad está dada por:
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-41}{}{\label{def:unnamed-chunk-41} }Si \(Z_1\), \(\cdots\), \(Z_n\) son variables aleatorias independientes e idénticamente distribuidas con distribución normal estándar, entonces la variable \(\sum_{i=1}^nZ_i^2\) tiene distribución Ji-cuadrado con \(n\) grados de libertad.
\end{definition}

\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-42}{}{\label{prp:unnamed-chunk-42} }Si \(Y\) es una variable aleatoria con distribución Ji-cuadro con \(n\) grados de libertad, entonces
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-43}{}{\label{prp:unnamed-chunk-43} }Sea \(Z_1\), \(\cdots\), \(Z_m\) variables aleatorias independientes con distribución \(\chi^2_{n_i}\) para \(i=1,\cdots,m\), entonces la variable \(\sum_{i=1}^mZ_i\) tiene distribución Ji-cuadrado con \(\sum_{i=1}^mn_i\) grados de libertad.
\end{proposition}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-44}{}{\label{def:unnamed-chunk-44} }Una variable aleatoria \(Y\) tiene distribución t-student con \(n\) grados de libertad si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-46}{}{\label{prp:unnamed-chunk-46} }Si \(Y\) es una variable aleatoria con distribución t-student con \(n\) grados de libertad, entonces
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-47}{}{\label{def:unnamed-chunk-47} }Una variable aleatoria \(Y\) tiene distribución t-student con \(n\) grados de libertad, parámetro de centralidad \(\theta\) y parámetro de escala \(\sigma^2\), si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-48}{}{\label{prp:unnamed-chunk-48} }Si \(Y\) es una variable aleatoria con distribución t-student generalizada, entonces
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-49}{}{\label{def:unnamed-chunk-49} }Una variable aleatoria \(Y\) tiene distribución F con \(m\) grados de libertad en el numerador y \(n\) grados de libertado en el denominador si su función de densidad está dada por:
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-50}{}{\label{def:unnamed-chunk-50} }Sea \(Y\) y \(Y\) variables aleatorias independientes con distribuciones Ji-cuadrado con \(m\) y \(n\) grados de libertad, respectivamente, entonces la variable \(\frac{Y/m}{Y/n}\) tiene distribución F con \(m\) grados de libertad en el numerador y \(n\) grados de libertado en el denominador.
\end{definition}

\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-51}{}{\label{prp:unnamed-chunk-51} }Si \(Y\) es una variable aleatoria con distribución F con \(m\) grados de libertad en el numerador y \(n\) grados de libertado en el denominador, entonces
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-52}{}{\label{def:unnamed-chunk-52} }Un vector aleatorio \(\mathbf{Y}=(Y_1,\ldots,Y_p')\) tiene distribución multinomial si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-53}{}{\label{prp:unnamed-chunk-53} }Si \(\mathbf{Y}\) es una vector aleatorio con distribución multinomial, entonces
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-54}{}{\label{def:unnamed-chunk-54} }Un vector aleatorio \(\mathbf{Y}=(Y_1,\ldots,Y_p')\) tiene distribución Dirichelt si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-55}{}{\label{prp:unnamed-chunk-55} }Si \(\mathbf{Y}\) es una vector aleatorio con distribución Dirichlet, entonces
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-56}{}{\label{def:unnamed-chunk-56} }Un vector aleatorio \(\mathbf{Y}=(Y_1,\ldots,Y_p')\) tiene distribución normal multivariante de orden \(p\), denotada como \(\mathbf{Y}\sim N_p(\boldsymbol \theta,\boldsymbol \Sigma)\), si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-57}{}{\label{prp:unnamed-chunk-57} }Si \(\mathbf{Y}=(Y_1,\ldots,Y_p')\) es una vector aleatorio con distribución normal multivariante, entonces
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-58}{}{\label{prp:unnamed-chunk-58} }Si \(\mathbf{Y}\) es una vector aleatorio con distribución Normal Multivariante, entonces
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-59}{}{\label{prp:unnamed-chunk-59} }Dado \(\mathbf{Y}\) un vector aleatorio particionado como \(\mathbf{Y}=(\mathbf{Y}_1',\mathbf{Y}_2')\) con esperanza \(\boldsymbol \theta=(\boldsymbol \theta_1',\boldsymbol \theta_2')\) y matrix de varianzas y covarianzas
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-60}{}{\label{prp:unnamed-chunk-60} }Si \(\mathbf{Y}_1,\ldots,\mathbf{Y}_n\) es una muestra aleatoria de vectores con distribución Normal Multivariante, entonces la verosimilitud de la muestra se puede escribir como
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-63}{}{\label{prp:unnamed-chunk-63} }Si \(\boldsymbol \Sigma\) es una matriz aleatoria con distribución Wishart con \(v\) grados de libertad, entonces \(E(\boldsymbol \Sigma)=v\boldsymbol \Lambda\)
\end{proposition}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-64}{}{\label{def:unnamed-chunk-64} }Sea \(\boldsymbol \Sigma\) una matriz aleatoria simétrica y definida positiva de tamaño \(p\times p\). Se dice que \(\boldsymbol \Sigma\) tiene distribución Wishart con \(v\) grados de libertad, denotada como \(\mathbf{Y}\sim Wishart_v(\boldsymbol \Lambda)\), si su función de densidad está dada por:
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-65}{}{\label{prp:unnamed-chunk-65} }Si \(\boldsymbol \Sigma\) es una matriz aleatoria con distribución inversa-Wishart con \(v\) grados de libertad, entonces \(E(\boldsymbol \Sigma)=\dfrac{1}{v-p-1}\boldsymbol \Lambda\)
\end{proposition}

\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-66}{}{\label{prp:unnamed-chunk-66} }Si \(\boldsymbol \Sigma^{-1}\) es una matriz aleatoria con distribución inversa-Wishart, entonces con \(\boldsymbol \Sigma\) tiene distribución Wishart.
\end{proposition}
...
\hypertarget{simulaciuxf3n-de-distribuciones-de-probabilidad}{%
\chapter{Simulación de distribuciones de probabilidad}\label{simulaciuxf3n-de-distribuciones-de-probabilidad}}
...
\section{Método de la transformación uniforme}\label{muxe9todo-de-la-transformaciuxf3n-uniforme}}
...
\section{Método de la grilla}\label{muxe9todo-de-la-grilla}}
